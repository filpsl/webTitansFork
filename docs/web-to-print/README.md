...
```
  ...
  ┌─────────────────────┐        ┌──────────────────────┐       ┌─────────────────────┐
  │ /impressao (React)  │        │ /api/payments/        │       │ print-worker.py     │
...
| --- | --- | --- | --- |
| **Checkout** | Navegador (React/Vite) | Upload, contagem de páginas, preço, pagamento, acompanhamento | [`web-to-print-checkout`](../../openspec/specs/web-to-print-checkout/spec.md) |
| **Pagamento PIX** | Vercel (Serverless Functions) | Gera o PIX e processa o webhook do Mercado Pago | [`mercadopago-pix-integration`](../../openspec/specs/mercadopago-pix-integration/spec.md) |
...
4. [Pagamento PIX (Serverless Functions)](04-pagamento-pix.md) — `create-pix` e o webhook.
